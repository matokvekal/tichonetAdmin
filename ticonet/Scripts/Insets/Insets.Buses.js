insets.buses = {
    ...
    //},
    editBus: function (id) {
        if (id && id !== insets.table.lastSel) {
            insets.table.busesGrid.restoreRow(insets.table.lastSel);
            insets.table.lastSel = id;
        }
        insets.table.busesGrid.editRow(id, true);
    ...
    cancelEditBus: function (id) {
        insets.table.busesGrid.restoreRow(id);
        $('.js-bus-save-button-container-' + id).hide();
        $('.js-bus-edit-button-container-' + id).show();
    },

    saveBus: function (id) {
        insets.table.busesGrid.saveRow(id, true);
        //insets.table.busesGrid.restoreRow(id);
        //$('.js-bus-save-button-container-' + id).hide();
        //$('.js-bus-edit-button-container-' + id).show();
    },
    ...
    addBus: function () {
        insets.table.busesGrid.addRow(0);
        //insets.table.busesGrid.editBus(0);
        //insets.table.busesGrid.restoreRow(id);
        //$('.js-bus-save-button-container-' + id).hide();
        //$('.js-bus-edit-button-container-' + id).show();
    },
